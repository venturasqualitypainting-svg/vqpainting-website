      ...
      <div className="relative min-h-[200px]">
        <div className="bg-white rounded-xl p-6 md:p-8 shadow-card border-l-4 border-primary-light transition-opacity duration-400">
          ...
          <p className="font-heading font-semibold text-dark text-base md:text-lg italic leading-relaxed mb-4">
            &ldquo;    "Ventura's Quality Painting delivers flawless interior and exterior painting for homes and 
businesses throu...
  Phoenix, Arizona.",{t(t2.textEn, t2.textEs)}&rdquo;
          </p>
...
{/* Hero Section */} <section
   ref={heroRef}
   className="relative min-h-[600px] max-h-[900px] h-[85vh] flex items-center"
 > <img
     ref={heroImgRef}
     src="/images/hero-nueva.jpg"
     alt="Ventura's Quality Painting - Phoenix Arizona"
...
```
  ...
  <div className="relative z-10 content-max text-center pt-20">
    <ScrollReveal>
      <span className="inline-block bg-white/15 backdrop-blur-md border border-white/30 rounded-full px-4 py-1.5 text-xs font-medium tracking-widest text-white">
        Licensed, Bonded & Insured
      </span>
    </ScrollReveal>

    <ScrollReveal delay={0.2}>
      <h1 className="font-heading font-extrabold text-white text-4xl md:text-5xl lg:text-6xl leading-[1.1] tracking-tight mt-6">
    ...
    <ScrollReveal delay={0.5}>
      <p className="font-body text-white/90 text-base md:text-lg max-w-[640px] mx-auto mt-6">
        Ventura's Quality Painting delivers flawless interior and exterior
        painting for homes and businesses throughout Phoenix, Arizona.
      </p>
    </ScrollReveal>
    ...
    <ScrollReveal delay={0.7}>
      <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-10">
        <a
          href="#contacto"
          className="inline-block bg-primary hover:bg-primary/90 text-white px-8 py-4 rounded-full font-semibold"
        >
          Get a Free Estimate
        </a>
        ...
        <a
          href="tel:6025859189"
          className="inline-block border border-white/50 hover:bg-white/10 text-white px-8 py-4 rounded-full font-semibold flex items-center gap-2"
        >
          <Phone className="w-5 h-5" />
          Call Now: 602-585-9189
        </a>
      </div>
    </ScrollReveal>
  </div>
      ...
      <div className="content-max">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
          {[
            ...
            { en: "15+ Years Experience", es: "15+ Años de Experiencia" },
            { en: "5-Star Rated", es: "Calificación 5 Estrellas" },
            { en: "Phoenix Area", es: "Área de Phoenix" },
          ].map((item, i) => (
            <div
              key={i}
            ...
            >
              ...
              <span className="font-body font-medium text-dark text-sm">
                {t(item.en, item.es)}
              </span>
            </div>
          ))}
...
font-medium text-dark text-sm">{t(item.en, item.es)}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <ScrollReveal direction="left">
              <div className="rounded-xl overflow-hidden shadow-lg">
                <img
                  ...
                  className="w-full aspect-[4/5] lg:aspect-[4/5] object-cover"
                  loading="lazy"
                />
              </div>
            </ScrollReveal>
